...
public class MainActivity extends AppCompatActivity {
    ...
    public void cargarDatos(){
        ...
        lista.add(new Inmueble(R.drawable.caballo,"Caballo", 10000));
        lista.add(new Inmueble(R.drawable.minion,"Minion", 500000));
        lista.add(new Inmueble(R.drawable.sapo,"Sapo", 6500000));
    }
